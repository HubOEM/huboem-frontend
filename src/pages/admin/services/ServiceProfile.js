const orders = [
    {
        ...
        products: [
            {
                id: 1,
                name: 'Checked electircal stuff',
                href: 'service{id}/item{id}',
                price: '$70.00',
                status: 'Serviced Jan 25, 2021',
                imageSrc: 'https://image.made-in-china.com/202f0j00NUzYaeDCbFok/Pilow-Pack-Machine-Automatic-Dry-Food-Packaging-Machine.webp',
                imageAlt: 'Detail of mechanical pencil tip with machined black steel shaft and chrome lead tip.',
            },
            {
                id: 1,
                name: 'Replaced blades and tested',
                href: 'service{id}/item{id}',
                price: '$70.00',
                status: 'Serviced Jan 25, 2021',
                imageSrc: 'https://bachknives.com/wp-content/uploads/2022/12/Food-Processing-hero-image.png',
                imageAlt: 'Detail of mechanical pencil tip with machined black steel shaft and chrome lead tip.',
            },
            {
                id: 1,
                name: 'Repaired broken clamp (S-4)',
                href: 'service{id}/item{id}',
                price: '$70.00',
                status: 'Serviced Jan 25, 2021',
                imageSrc: 'https://m.media-amazon.com/images/I/51DJWpAYXIL._AC_UF894,1000_QL80_.jpg',
                imageAlt: 'Detail of mechanical pencil tip with machined black steel shaft and chrome lead tip.',
            },
        ],
    },
        ...
        <div className="bg-white">
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:pb-24">
                <div className="max-w-xl">
                    <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Service history</h1>
                    <p className="mt-2 text-sm text-gray-500">
                        These were the items addressed in your service visit.
                    </p>
                </div>

                <div className="mt-16">
                    <h2 className="sr-only">Recent services</h2>

                    <div className="space-y-20">
                        {orders.map((order) => (
                            <div key={order.number}>
                                <h3 className="sr-only">
                                    Serviced on <time dateTime={order.datetime}>{order.date}</time>
                                </h3>
                                ...
                                <div className="rounded-lg bg-gray-50 px-4 py-6 sm:flex sm:items-center sm:justify-between sm:space-x-6 sm:px-6 lg:space-x-8">
                                    <dl className="flex-auto space-y-6 divide-y divide-gray-200 text-sm text-gray-600 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:space-y-0 sm:divide-y-0 lg:w-1/2 lg:flex-none lg:gap-x-8">
                                        <div className="flex justify-between sm:block">
                                            <dt className="font-medium text-gray-900">Date serviced</dt>
                                            <dd className="sm:mt-1">
                                                <time dateTime={order.datetime}>{order.date}</time>
                                            </dd>
                                        </div>
                                        <div className="flex justify-between pt-6 sm:block sm:pt-0">
                                            <dt className="font-medium text-gray-900">Service number</dt>
                                ...
                                <table className="mt-4 w-full text-gray-500 sm:mt-6">
                                    <caption className="sr-only">Service Item</caption>
                                            ...
                                            <tr key={product.id}>
                                                ...
                                                <td className="whitespace-nowrap py-6 text-right font-medium">
                                                    <a href={product.href} className="text-indigo-600">
                                                        View<span className="hidden lg:inline"> Service Item</span>
