                            ...
                            <ul role="list" className="divide-y divide-gray-200">
                                ...
                                {machines.map((machine) => (
                                    <li key={machine.id} className="px-4 py-4 sm:px-6">
                                        <div className="flex">
                                            <div className="flex-1">{machine.modelName}</div>
    ...
    return (
        <div className="mx-auto max-w-7xl sm:px-6 sm:pt-16 lg:px-8 mb-12">
            ...
            <div className="flex justify-center my-4">
                <button
                    className={`mx-2 px-4 py-2 rounded ${activeTab === 'Orders' ? 'bg-blue-500 hover:bg-blue-400   text-white' : 'bg-gray-300'
                        }`}
                ...
                <button
                    className={`mx-2 px-4 py-2 rounded ${activeTab === 'Service Requests' ? 'bg-blue-500 hover:bg-blue-400  text-white' : 'bg-gray-300'
                        }`}
                ...
                <button
                    className={`mx-2 px-4 py-2 rounded ${activeTab === 'Machines' ? 'bg-blue-500 hover:bg-blue-400  text-white' : 'bg-gray-300'
                        }`}
                ...
                <button
                    className={`mx-2 px-4 py-2 rounded ${activeTab === 'Customers' ? 'bg-blue-500 hover:bg-blue-400  text-white' : 'bg-gray-300'
                        }`}
